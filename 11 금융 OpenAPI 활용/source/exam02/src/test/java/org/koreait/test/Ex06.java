...
public class Ex06 {
    ...
    void test2(){
        ...
        booleanBuilder.and(member.email.contains("user"))
                .and(member.name.contains("사용자"));

        List<Member> members = (List<Member>) repository.findAll(booleanBuilder, member.createdAt.desc());
        members.forEach(System.out::println);
    }
